...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | The 114 surahs in Mushaf order with their standard ayah counts. Used
    | to populate the surah/ayah pickers in the memorization-tracking form
    | and to validate submitted ayah ranges server-side.
    |
    */
